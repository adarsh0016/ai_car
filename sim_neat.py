...
class Car:
    ...
    def get_default_data(self):
        ...
        return_values = [0, 0, 0, 0, 0, 0, 0, 0] # eight sensors
    ...
    def get_reward(self):
        ...
        if (self.last_choice == 2 and self.choice == 0) or (self.last_choice == 0 and self.choice == 2) or (self.last_choice == 4 and self.choice == 5) or (self.last_choice == 5 and self.choice == 4):
            self.param = -5
        else:
            self.param = 2
        ...
        return round(self.distance/(self.time * 20) + self.vel / 14 + self.pram)
